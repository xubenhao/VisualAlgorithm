...
#ifndef APP_UI_LISTINTRODUCEDRAWINGWIDGET_H
#define APP_UI_LISTINTRODUCEDRAWINGWIDGET_H

#include "Ui/header.h"

class ListIntroduceDrawingWidget : public QWidget
{
    Q_OBJECT
public:
    explicit ListIntroduceDrawingWidget(QWidget *parent = nullptr);
...
#endif // LISTINTRODUCEDRAWINGWIDGET_H
