...
#ifndef APP_UI_ARRAYINTRODUCEDRAWINGWIDGET_H
#define APP_UI_ARRAYINTRODUCEDRAWINGWIDGET_H

#include "Ui/header.h"

class ArrayIntroduceDrawingWidget : public QWidget
{
    Q_OBJECT
public:
    explicit ArrayIntroduceDrawingWidget(QWidget *parent = nullptr);
    void Initialize();
...
#endif // ARRAYINTRODUCEDRAWINGWIDGET_H
